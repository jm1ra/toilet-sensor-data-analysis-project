...
// src/components/ReplaceData.jsx
//importing necessary libaries and components for ReplaceData
...
//Gather data from Toilet sensor 1 and Toilet Sensor 2 tables.
...
export default function AddData() {
    ...
    //Validates a CSV file is selected, reads it as text, parses it into rows and throws if no valid rows are found before proceeding with the upload
